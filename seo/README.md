# Peak Signal SEO week-1 landers (2026-09-04)

HTML-first pages for locked primaries. Mount `seoLandersRouter` on the Peak Replit Autoscale api-server **before** the SPA catch-all.
